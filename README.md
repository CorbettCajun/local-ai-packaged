...
1. Run Ollama on your Mac for faster inference, and connect to that from the n8n instance:
...
and nodes. If you run into an issue, go to [Troubleshooting](#troubleshooting).
